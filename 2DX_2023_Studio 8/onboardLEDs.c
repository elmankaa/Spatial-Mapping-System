...
void onboardLEDs_Init(void){
	...
	GPIO_PORTN_DIR_R |= 0xFF;        								// make PN0 out (PN0 built-in LED1)
  GPIO_PORTN_AFSEL_R &= ~0xFF;     								// disable alt funct on PN0,PN1
  GPIO_PORTN_DEN_R |= 0xFF;        								// enable digital I/O on PN0,PN1
